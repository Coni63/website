...
-->
            ...
            <div class="col-lg-8 col-lg-offset-2"> 
                <p><t><?= _PUZZLE71_TITLE ?></t></p>
                <p><more><?= _PUZZLE71_DESC ?></more></p>
            </div>

            <div class="col-lg-2 pro">
                <ul>
                    <li class="link_tips"><imp><a class="white" href="solution/accident/home.html" target="_blank"><?= _SHOW_SOLUTION ?></a></imp></li>
                </ul>
            </div>
            
            <div class="col-lg-8 col-lg-offset-2"> 
                <p><t><?= _PUZZLE72_TITLE ?></t></p>
                <p><more><?= _PUZZLE72_DESC ?></more></p>
            </div>

            <div class="col-lg-2 pro">
                <ul>
                    <li class="link_tips"><imp><a class="white" href="solution/fractals/Fractals.html" target="_blank"><?= _SHOW_SOLUTION ?></a></imp></li>
                    <li class="link_tips"><imp><a class="white" href="solution/fractals/Fractals.ipynb" download="Fractals.ipynb"><?= _DL_SOLUTION ?></a></imp></li>
                    <li class="link_tips"><imp><a class="white" href="solution/fractals/fractals.py" download="Fractals.py"><?= _DL_SCRIPT ?></a></imp></li>
                </ul>
            </div>
