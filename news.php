<html lang="en">
    ...
    <div class="container desc animated wow fadeInDown">
        <div class="row">
            ...
            <div class="col-lg-6">
                <p><t><?= _NEWS72_TITLE ?></t><br/>
                    <?= _NEWS72_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS72_DATE ?></sm></p>
            </div>
            
            <div class="col-lg-6 col-lg-offset-3">
                <p><t><?= _NEWS71_TITLE ?></t><br/>
                    <?= _NEWS71_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS71_DATE ?></sm></p>
            </div>
            
            <div class="col-lg-6 col-lg-offset-3">
                <p><t><?= _NEWS70_TITLE ?></t><br/>
                    <?= _NEWS70_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS70_DATE ?></sm></p>
            </div>
            
            <div class="col-lg-6 col-lg-offset-3">
                <p><t><?= _NEWS69_TITLE ?></t><br/>
                    <?= _NEWS69_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS69_DATE ?></sm></p>
            </div>
            
            <div class="col-lg-6 col-lg-offset-3">
                <p><t><?= _NEWS68_TITLE ?></t><br/>
                    <?= _NEWS68_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS68_DATE ?></sm></p>
            </div>
            
            <div class="col-lg-6 col-lg-offset-3">
                <p><t><?= _NEWS67_TITLE ?></t><br/>
                    <?= _NEWS67_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS67_DATE ?></sm></p>
            </div>
            
            <div class="col-lg-6 col-lg-offset-3">
                <p><t><?= _NEWS66_TITLE ?></t><br/>
                    <?= _NEWS66_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS66_DATE ?></sm></p>
            </div>
            
            <div class="col-lg-6 col-lg-offset-3">
                <p><t><?= _NEWS65_TITLE ?></t><br/>
                    <?= _NEWS65_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS65_DATE ?></sm></p>
            </div>
            ...
            <div class="col-lg-3">
                <p><sm><?= _NEWS62_DATE ?></sm></p>
            </div>
            
            <div class="col-lg-6 col-lg-offset-3">
                <p><t><?= _NEWS61_TITLE ?></t><br/>
                    <?= _NEWS61_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS61_DATE ?></sm></p>
            </div>
            
            <div class="col-lg-6 col-lg-offset-3">
                <p><t><?= _NEWS60_TITLE ?></t><br/>
                    <?= _NEWS60_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS60_DATE ?></sm></p>
            </div>
            
            <div class="col-lg-6 col-lg-offset-3">
                <p><t><?= _NEWS59_TITLE ?></t><br/>
                    <?= _NEWS59_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS59_DATE ?></sm></p>
            </div>
            
            <div class="col-lg-6 col-lg-offset-3">
                <p><t><?= _NEWS58_TITLE ?></t><br/>
                    <?= _NEWS58_DESC ?>
                </p>
            </div>
            
            <div class="col-lg-3">
                <p><sm><?= _NEWS58_DATE ?></sm></p>
            </div>
